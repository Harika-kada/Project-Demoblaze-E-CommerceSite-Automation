...
public class CartTests {
    ...
    public void testAddProductToCart(String productName, String action, double expectedCount, double expectedPrice) {
        ...
        Assert.assertTrue(cartPage.isProductInCart(productName), "The product " + productName + " was not found in the cart.");
    ...
    public void testRemoveProductFromCart(String productName, String action, double expectedCount, double expectedPrice) {
        ...
        cartPage.goToCart();
        Assert.assertTrue(cartPage.isProductInCart(productName), "The product to be removed was not found in the cart.");

        cartPage.removeProduct(productName);
        Assert.assertTrue(cartPage.isProductRemoved(productName), "The product " + productName + " should have been removed from the cart.");
    ...
    public void testCartPersistenceAcrossSessions() {
        ...
        Assert.assertTrue(cartPage.isProductInCart("Nokia lumia 1520"), "Testcase failed: Product was not found after restarting session.");
    ...
    public void testPriceCalculationVerification() {
        ...
        Assert.assertEquals(totalPriceInCart, originalPrice, "The price in the cart does not match the product's original price.");
    }
}
